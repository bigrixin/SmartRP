...
namespace SmartRP.Infrastructure.Data
{
	public sealed class SmartRPDbContext : DbContext, IWriteEntities
	{
		...
		public DbSet<ExternalSupervisor> ExternalSupervisors { get; set; }
		...
		public DbSet<JoinProjectGroup> JoinProjectGroups { get; set; }

		public DbSet<UserSkill> UserSkills { get; set; }
		public DbSet<ProjectSkill> ProjectSkills { get; set; }
		public DbSet<TRPToRP> TRPToRPs { get; set; }
		...
		protected override void OnModelCreating(DbModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<CoSupervisor>().ToTable("CoSupervisor");
			modelBuilder.Entity<ExternalSupervisor>().ToTable("ExternalSupervisor");
			modelBuilder.Entity<Student>().ToTable("Student");

			modelBuilder.Entity<Term>().ToTable("Term");
			modelBuilder.Entity<Subject>().ToTable("Subject");
			modelBuilder.Entity<ProjectPool>().ToTable("ProjectPool");
			modelBuilder.Entity<Project>().ToTable("Project");
			modelBuilder.Entity<PreProject>().ToTable("PreProject");
			...
			modelBuilder.Entity<UserKeyword>().ToTable("UserKeyword");
			modelBuilder.Entity<ProjectKeyword>().ToTable("ProjectKeyword");
			modelBuilder.Entity<JoinProjectGroup>().ToTable("JoinProjectGroup");

			modelBuilder.Entity<UserSkill>().ToTable("UserSkill");
			modelBuilder.Entity<ProjectSkill>().ToTable("ProjectSkill");
			modelBuilder.Entity<TRPToRP>().ToTable("TRPToRP");
		}
