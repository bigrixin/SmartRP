...
namespace SmartRP.Infrastructure.Auth
{
	public class AspNetIdentityEmailService : IIdentityMessageService
	{
		...
		public Task SendAsync(IdentityMessage message)
		{
			...
			html += HttpUtility.HtmlEncode(@"Welcome to register UTS Research Project Management Portal (SmartRP 2)!  Please click on the or copy the following link on the browser:  " + message.Body);
			#endregion
